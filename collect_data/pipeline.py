"""Football data collection pipeline (scrapers + unified build).
...
Usage:
  python3 collect_data.py                        # all sources + SofaScore matches + ClubElo + unified table
  python3 -m collect_data --sofascore-only       # SofaScore season stats only
  python3 -m collect_data --rebuild-only          # rebuild unified parquet from raw files
"""
...
from collect_data.storage import (
    DATA_DIR,
    FRESHNESS_PATH,
    RAW_DIR,
    repo_root,
